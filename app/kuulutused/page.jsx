...
const Kuulutused = () => {
    const items = [
    {
      title: "Vajan torumeest",
      description: "Vajan torumeest, kes ühedaks ära uue duššisegisti (fotol). "
    },
    {
      title: "Värvimistööd",
      description: "Elutoa värvimistööd ja elektri paigaldus."
    },
    {
      title: "Kuuri remont",
        ...
        <main className="px-12">
            ...
            <ul>
                ...
                <li key={index} className="p-4 flex flex-col items-start gap-8 pb-16">
                    ...
                    <Link className="text-bold text-center rounded-full px-8 py-4 w-[12rem] border-[1px] bg-[var(--yellow)]" href="/kuulutus">Ava kuulutus</Link>
                </li>
                ))}
            </ul>
        </main>
